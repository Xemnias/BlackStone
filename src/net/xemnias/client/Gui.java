...
public abstract class Gui 
{
	...
	public void drawRoundRectWithColor(Graphics g, float x, float y, int w, int h, int rad, Color black)
	{
		g.setColor(black);
		g.drawRoundRect(x, y, w, h, rad);
	}
	
	public void fillRoundRectWithColor(Graphics g, float f, float g2, int w, int h, int rad, Color display)
	{
		g.setColor(display);
		g.fillRoundRect(f, g2, w, h, rad);
	}
