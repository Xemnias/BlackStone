...
public class BlockTreePopper02 extends Block
{

	public BlockTreePopper02(int i, String name) 
	{
		super(i, name);
		sprite = BlackStone.loader.getTextureById(4, 16, "forest.png");
		collision = true;
	}
	...
	private class upRight extends Block
	{
		...
		public upRight(int i, String name) {
			super(i, name);
			sprite = BlackStone.loader.getTextureById(5, 16, "forest.png");
		}
	...
	private class downLeft extends Block
	{
		...
		public downLeft(int i, String name) {
			super(i, name);
			sprite = BlackStone.loader.getTextureById(6, 16, "forest.png");
		}
	...
	private class downRight extends Block
	{
		...
		public downRight(int i, String name) {
			super(i, name);
			sprite = BlackStone.loader.getTextureById(7, 16, "forest.png");
		}
